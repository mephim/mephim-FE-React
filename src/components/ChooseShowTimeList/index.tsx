...
function ChooseShowTimeList({ movie }: IProp) {
    ...
    const dateList: DateWrap[] = [
        {
            dateDetail: formatDate(new Date(new Date().setDate(new Date().getDate()))),
            date: new Date(new Date().setDate(new Date().getDate())).getDate(),
            day: new Date(new Date().setDate(new Date().getDate())).getDay(),
        },
        {
            dateDetail: formatDate(new Date(new Date().setDate(new Date().getDate() + 1))),
            date: new Date(new Date().setDate(new Date().getDate() + 1)).getDate(),
            day: new Date(new Date().setDate(new Date().getDate() + 1)).getDay(),
        },
        {
            dateDetail: formatDate(new Date(new Date().setDate(new Date().getDate() + 2))),
            date: new Date(new Date().setDate(new Date().getDate() + 2)).getDate(),
            day: new Date(new Date().setDate(new Date().getDate() + 2)).getDay(),
        },
        {
            dateDetail: formatDate(new Date(new Date().setDate(new Date().getDate() + 3))),
            date: new Date(new Date().setDate(new Date().getDate() + 3)).getDate(),
            day: new Date(new Date().setDate(new Date().getDate() + 3)).getDay(),
        },
        {
            dateDetail: formatDate(new Date(new Date().setDate(new Date().getDate() + 4))),
            date: new Date(new Date().setDate(new Date().getDate() + 4)).getDate(),
            day: new Date(new Date().setDate(new Date().getDate() + 4)).getDay(),
        },
        {
            dateDetail: formatDate(new Date(new Date().setDate(new Date().getDate() + 5))),
            date: new Date(new Date().setDate(new Date().getDate() + 5)).getDate(),
            day: new Date(new Date().setDate(new Date().getDate() + 5)).getDay(),
        },
        {
            dateDetail: formatDate(new Date(new Date().setDate(new Date().getDate() + 6))),
            date: new Date(new Date().setDate(new Date().getDate() + 6)).getDate(),
            day: new Date(new Date().setDate(new Date().getDate() + 6)).getDay(),
        },
    ];
        ...
        if (showDate?.length === 0) {
            ...
            findShowTimeByMovieAndShowDateRequest(Number(movie?.movieId), Number(showDate[0].showDateId)).then((res) => {
                if (res.data === null) {
                    ...
                    setListShowTimeExist(res.data.data);
                }
            });
        }
    };
                    ...
                    {dateList.map((dateWrap: DateWrap, index: number) => (
                        <div key={index}>
                            <span className="d-block text-center">
                                {dayList.filter((dayWrap) => dayWrap.day === dateWrap.day)[0].name}
                            </span>
                            <span
                                className={`date-element ${dateWrap.date === dateActive ? ' active' : ''}`}
                                onClick={(e) => {
